...
namespace LibreriaConnection.controller
{
    class ControllerAutor
    {
        ...
        {
            bool result = false;
            string sql = $"CALL InsertarAutor('{objAutor.Nombre1Autor}', '{objAutor.Nombre2Autor}', '{objAutor.Apellido1Autor}', '{objAutor.Apellido2Autor}', '{objAutor.DireccionAutor}', '{objAutor.TelefonoAutor}', {objAutor.IdCiudadAutor});";
